# -*- coding: utf-8 -*-
"""SEESCode_Ingle_Kurelli_Knuth.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1RT4S1Bt-b0dSUUPHEaTGxkMYSnHUhuxU
...
> AppEEARS Layer = NDVI index & 250m pixel size (This is the most focussed pixel size, which is still larger than our SEES 100m grid ... which results in some error)

##**Step 1** -- Determine Appropriate Pixel Size
> SEES GLOBE Observations were conducted on a 100m grid, so we chose the AppEEARS pixel size closest to that value: 250m grid ...
"""

#This does not really affect our code as of this point.
